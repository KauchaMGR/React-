        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              ...
              <a className="nav-Link active text-decoration-none text-white me-3" aria-current="page" href="/home">{props.home}</a>
            </li>
            <li className="nav-item">
              {/* <Link className="nav-Link active text-white text-decoration-none me-3" to="/about">{props.news}</Link> */}
              <a className="nav-Link active text-white text-decoration-none me-3" href="/about">{props.news}</a>
            </li>
          </ul>
